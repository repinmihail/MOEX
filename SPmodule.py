...
def cr_rates(obj):
    ...
    obj.HKD_rate = 0
    obj.rates = pd.DataFrame({'RUB':[obj.RUB_rate],'USD':[obj.USD_rate],'EUR':[obj.EUR_rate],'JPY':[obj.JPY_rate],'HKD':[obj.HKD_rate]})
    print('Ставки\n', obj.rates)
...
def ytm_distr(obj):
    ...
    obj.ytm_perc_db = obj.perc.to_dict()
